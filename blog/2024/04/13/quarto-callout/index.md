...
If you're a VSCode user, don't make an effort to remember the correct syntax but use the *Snippet* feature of VSCode.
...
1. First the type of callout and you'll have a list of possible values; easy no?
...
VSCode will show you the snippet interactively and you can then, easily, create it without having to remember the correct syntax.
