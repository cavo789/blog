...
Two `docker run` commands, two GUI apps in a browser tab — no install, no cleanup. If you'd
rather have these applications open as real windows on your desktop instead of inside a browser
tab, <Link to="/blog/docker-run-linux-gui">Docker - Run Graphical User Interfaces - Firefox, Chrome & GIMP</Link> covers that variant.
