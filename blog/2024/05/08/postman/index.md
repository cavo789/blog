...
![Creating an environment](./images/creating_environment.webp)
...
![Using the base URL](./images/using_base_url.webp)
...
![Collection with global tests](./images/collection_tests.webp)
...
![The request tests](./images/request_tests.webp)
...
![Result request - Tests](./images/request_results_tests.webp)

## Exporting / importing a collection

By putting all your requests in a collection, you can easily export it (as a `.json` file)

![Exporting a collection](./images/exporting_collection.webp)

And, of course, import it almost the same way:

![Importing a collection](./images/importing_collection.webp)
...
![Check VAT service headers](./images/checkVatService_request_headers.webp)
...
![Check VAT service body](./images/checkVatService_request_body.webp)
...
![Check VAT service response](./images/checkVatService_request_response.webp)
