...
In the introduction of this article, I have said _we will learn how to use Docker to install Joomla and start a new website **in seconds**_.

And here is the promise. Just click on the `Generate install script` below, copy/paste the script in your console, run it and follow the instruction. After a few seconds, you'll have a running Joomla website.
