...
<ProjectSetup folderName="/tmp/joomla">
  <Guideline>
    ...
    create your Joomla site. The database type should be `MySQLi`, the name of
    the host should be `joomladb`, the username should be `root` and the
    password for that user should be `example`.
  </Guideline>
