...
Run `docker compose up --detach`, wait for the images to download, then open `http://localhost:8080`:
...
<BrowserWindow url="http://localhost:8080/aministrator/index.php">
...
Let us try by starting your favorite browser and navigating to `http://localhost:8080` (_or `http://127.0.0.1:8080`, it's strictly the same_) and... Wow! The Joomla installer shown at the beginning of this article is waiting for you.
...
<BrowserWindow url="http://localhost:8080/administrator">
...
<BrowserWindow url="http://kingsbridge:8080">
