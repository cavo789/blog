  ...
  updates={[
    {
      date: "2024-03-23",
      content:
        "adding health condition in yml and update Joomla tag to 5.1-php8.2-apache",
    },
    { date: "2025-08-25", content: "Using Joomla 5.3.3" },
  ]}
/>

In this article, we will learn how to use Docker to install Joomla on your localhost and start a new website **in seconds** _(don't want to wait? Jump to the "Final compose.yaml" chapter)_.
...
>
  ...
  [https://github.com/joomla-docker/docker-joomla/blob/8cac4ff7ae88b9274870a95f5e22ea3c32f01fd7/5.0/php8.1/apache/Dockerfile#L8](https://github.com/joomla-docker/docker-joomla/blob/8cac4ff7ae88b9274870a95f5e22ea3c32f01fd7/5.0/php8.1/apache/Dockerfile#L8)
  link, you can see that the Docker image for Joomla 5.0.0 is built on a
  `php:8.1-apache` image. This means that using this image, you will get PHP,
...
<AlertBox variant="info" title="You want MariaDB, not MySQL?">
  Nothing could be simpler! In the `compose.yaml` file, replace the line `image:
  mysql:8.0.13` with `image: mariadb:11.1.2` and save your change. That's it.
  It's piece of cake no?
</AlertBox>
...
drwxr-xr-x - christophe christophe 2025-08-25 09:32 .
drwxrwxrwt - christophe christophe 2025-08-25 09:32 ..
.rw-r--r-- 325 christophe christophe 2025-08-25 09:32 compose.yaml
...
<AlertBox variant="info" title="`docker compose up --detach`">
...
<AlertBox variant="info" title="What about a specific version of Joomla?">
...
During writing this article, Joomla _latest_ correspond to Joomla version 5.3.3. So, what about to force to use Joomla 5.0. By surfing on the [tags](https://hub.docker.com/_/joomla/tags) page, you can retrieve in the list of tags this one: _joomla:5.3.3-php8.2-apache_. So just replace `image: joomla` with `image: joomla:5.3.3-php8.2-apache` in `compose.yaml` and it's done. You're forcing a version. **Note: make sure to use a tag ending by `-apache`.**
...
services:
  joomla:
    // highlight-next-line
    image: joomla:5.3.3-php8.2-apache
[...]
```
...
<AlertBox variant="info" title="Just incredible; no?">
  Wow, doesn't that sound crazy? With a single command (`docker compose up
  --detach`), you have downloaded everything you need to get Joomla running on
  your machine.
</AlertBox>
...
<AlertBox variant="highlyImportant" title="The user UID/GID">
  If you don't do this, files and folders created by Docker will be owned by the
  `root` user on your computer and not by us (in my case, by the user called
  `christophe`).
</AlertBox>
...
$ ls -alh
Permissions Size User Group Date Modified Name
drwxr-xr-x - christophe christophe 2025-08-25 20:13 .
drwxrwxrwt - christophe christophe 2025-08-25 20:13 ..
drwxr-xr-x - christophe christophe 2025-08-25 20:13 db
drwxr-xr-x - christophe christophe 2025-08-25 20:13 site_joomla
.rw-r--r-- 478 christophe christophe 2025-08-25 20:13 compose.yaml
...
$ ls -alh site_joomla
Permissions Size User Group Date Modified Name
drwxr-xr-x - christophe christophe 2025-08-25 20:20 .
drwxr-xr-x - christophe christophe 2025-08-25 20:16 ..
...
.rw-r--r-- 6.9k christophe christophe 2025-08-25 20:20 .htaccess
...
$ ls -alh db
Permissions Size User Group Date Modified Name
drwxr-x--- - christophe christophe 2025-08-25 20:20 #innodb_temp
drwxr-xr-x - christophe christophe 2025-08-25 20:21 .
drwxr-xr-x - christophe christophe 2025-08-25 20:16 ..
drwxr-x--- - christophe christophe 2025-08-25 20:21 mysql
drwxr-x--- - christophe christophe 2025-08-25 20:21 performance_schema
drwxr-x--- - christophe christophe 2025-08-25 20:21 sys
.rw-r----- 56 christophe christophe 2025-08-25 20:21 auto.cnf
.rw------- 1.7k christophe christophe 2025-08-25 20:21 ca-key.pem
.rw-r--r-- 1.1k christophe christophe 2025-08-25 20:21 ca.pem
.rw-r--r-- 1.1k christophe christophe 2025-08-25 20:21 client-cert.pem
.rw------- 1.7k christophe christophe 2025-08-25 20:21 client-key.pem
.rw-r----- 50M christophe christophe 2025-08-25 20:21 ib_logfile0
.rw-r----- 50M christophe christophe 2025-08-25 20:20 ib_logfile1
.rw-r----- 13M christophe christophe 2025-08-25 20:21 ibdata1
.rw-r----- 13M christophe christophe 2025-08-25 20:20 ibtmp1
.rw-r----- 24M christophe christophe 2025-08-25 20:21 mysql.ibd
.rw------- 1.7k christophe christophe 2025-08-25 20:21 private_key.pem
.rw-r--r-- 452 christophe christophe 2025-08-25 20:21 public_key.pem
.rw-r--r-- 1.1k christophe christophe 2025-08-25 20:21 server-cert.pem
.rw------- 1.7k christophe christophe 2025-08-25 20:21 server-key.pem
.rw-r----- 10M christophe christophe 2025-08-25 20:21 undo_001
.rw-r----- 10M christophe christophe 2025-08-25 20:21 undo_002
...
Permissions Size User Group Date Modified Name
.rw-r--r-- 2.0k christophe christophe 2025-08-25 20:29 configuration.php
...
1. On your computer, create a folder for your new project (f.i. `mkdir ~/projects/my_new_project && cd $_`)
   <Terminal>$ mkdir ~/projects/my_new_project && cd $_</Terminal>
...
3. Create your two sub-folders
   <Terminal>$ mkdir db site_joomla</Terminal>
