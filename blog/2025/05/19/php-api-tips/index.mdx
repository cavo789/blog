...
When developing APIs _from scratch_, you can do it in the mode _I get behind the PC and start programming_, or _I learn about the standards first and then program in compliance with these standards_.
