...
>
  Using `PUT` implies you're intended to update each field of the record. If you
  plan to update just a few of them, take a look to the `PATCH` verb.
</AlertBox>
...
<AlertBox
  variant="info"
  title="You can translate `PATCH` as `UPDATE` in `CRUD`, when you'll DON'T update every fields"
>
