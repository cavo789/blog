...
Did you notice that other tests were also fired? Pest won't stop on failure.

</AlertBox>

The nice thing is: Pest has automatically taken a snapshot. See the error message, it says that a file `Tests/Browser/Screenshots/it_can_search_for_a_post` has been created automatically.
