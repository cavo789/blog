...
In this article, we'll override the standard page with the list of tags. As you know, natively, Docusaurus can display a page with the list of tags used across your articles if you access the **/blog/tags** page. So for my own blog, the page is [https://www.avonture.be/blog/tags](https://www.avonture.be/blog/tags) and you'll get something like this:
