...
A handful of files, one `docker build`, one `docker run`, and here's the result:

![First run](./images/first_run.webp)

<AlertBox variant="info">
Right now, you've copied a few files, built a Docker image and run Cypress in a container and you've got an *All specs passed!* message.
...
If everything is running fine, you'll get the same output already teased at the top of this article.
