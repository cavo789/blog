...
description: Ask Lovable.dev to create a full dockerized application with a backend using Python and FastAPI and a frontend using React.
...
Since AI played a real part in producing this post (and this app), it carries the "AI Assisted" badge — see <Link to="/blog/docusaurus-ai-gemini">how I indicate AI-assisted content</Link> in Docusaurus if you're curious how that works.
