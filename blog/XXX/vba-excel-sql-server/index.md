...
enableComments: true
---
![MS Excel - Connect to a SQL Server database, run a query and get the results](/img/excel_tips_header.jpg)
...
Imagine your sheet has already a nice layout with colors, titles having filters enabled and f.i. has a name (like `rngMyCustomers`). It would be nice if the updated data will respect all the layouts and just extends the name; no?
