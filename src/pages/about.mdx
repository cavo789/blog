  ...
  <TabItem value="achievements" label="Achievements" default>
    <Columns>
      <Column className='text--left'>
        <img src="/img/about/achievements.webp" class="about_images" loading="lazy" alt="Achievements" />
      </Column>
...
<TabItem value="highlights" label="Highlights">
  ...
  <TabItem value="networks" label="Social networks">
    <Columns>
      ...
      <Column className='text--left'>
        <img src="/img/about/social_networks.webp" class="about_images" loading="lazy" alt="Social networks" />
      </Column>
    </Columns>
  </TabItem>
</Tabs>
