...
<Tabs>
  ...
  <TabItem value="achievements" label="Achievements" default>
    <Columns>
      <Column className='text--left'>
        <img src="/img/about/achievements.png" alt="Achievements" />
      </Column>
  ...
  <TabItem value="major" label="Major achievements" default>
    <Columns>
      ...
      <Column className='text--left'>
        <img src="/img/about/major_realisations.png" alt="Major achievements" />
      </Column>
    </Columns>
  </TabItem>
  ...
  <TabItem value="highlights" label="Highlights">
   <Columns>
      <Column className='text--left'>
        <img src="/img/about/highlights.png" alt="Highlights" />
      </Column>
      <Column className='text--justify'>
  ...
  <TabItem value="networks" label="Social networks">
    <Columns>
      ...
      <Column className='text--left'>
        <img src="/img/about/social_networks.png" alt="Social networks" />
      </Column>
    </Columns>
  </TabItem>
</Tabs>
