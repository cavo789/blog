...
<Tabs>
  ...
  <TabItem value="major" label="Major achievements" default>
    <Columns>
      <Column className='text--justify'>
        * `AllEvents`: I created this benchmark extension for Joomla!, enabling advanced management of online events and calendars. It has been used by numerous associations and professional websites, and has been recognized as a flagship tool in the Joomla! ecosystem.
        * `aeSecure`: I developed this firewall dedicated to CMS, widely used to secure Joomla! and WordPress sites. aeSecure offers different versions and includes the “QuickScan” antivirus scan to detect malicious files. Many professionals have adopted it as an essential protection solution.
