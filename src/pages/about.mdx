...
<Tabs>
  ...
  <TabItem value="achievements" label="Achievements" default>
    <Columns>
      <Column className='text--left'>
        <img src="/img/about/achievements.png" loading="lazy" alt="Achievements" />
      </Column>
  ...
  <TabItem value="major" label="Major achievements" default>
    <Columns>
      ...
      <Column className='text--left'>
        <img src="/img/about/major_realisations.png" loading="lazy" alt="Major achievements" />
      </Column>
    </Columns>
  </TabItem>
  ...
  <TabItem value="highlights" label="Highlights">
   <Columns>
      <Column className='text--left'>
        <img src="/img/about/highlights.png" loading="lazy" alt="Highlights" />
      </Column>
      <Column className='text--justify'>
    ...
    <Columns>
      ...
      <div style={{
        ...
        <a href="https://bsky.app/profile/avonture.be" title="Bluesky">
          <LogoIcon name="bluesky" size='128' />
        </a>
        <a href="https://github.com/cavo789/" title="GitHub">
          <LogoIcon name="github" size='128' />
        </a>
        <a href="https://joomlacommunity.cloud.mattermost.com/main/messages/@cavo789" title="Mattermost">
          <LogoIcon name="mattermost" size='128' />
        </a>
      </div>
    </Column>
      <Column className='text--left'>
        <img src="/img/about/social_networks.png" loading="lazy" alt="Social networks" />
      </Column>
    </Columns>
  </TabItem>
</Tabs>
