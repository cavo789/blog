 ...
 */
function VarField({ id, name, label, defaultValue, value, onChange }) {
...
export default function Vars({ labels, ...defaults }) {
  ...
  // is what keeps the first paint identical to SSR (see store.js).
  useEffect(() => {
    let saved;
    try {
